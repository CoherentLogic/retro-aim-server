...
func (rt AlertServer) Start() {
	addr := net.JoinHostPort(rt.Config.OSCARListenHost, rt.Config.AlertPort)
	...
	rt.Logger.Info("starting ALERT service", "host", net.JoinHostPort(rt.Config.OSCARClientHost, rt.Config.AlertPort))
