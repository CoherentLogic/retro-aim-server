...
func (rt BOSServer) Start() {
	addr := net.JoinHostPort(rt.Config.OSCARListenHost, rt.Config.BOSPort)
	...
	rt.Logger.Info("starting BOS service", "host", net.JoinHostPort(rt.Config.OSCARClientHost, rt.Config.BOSPort))
