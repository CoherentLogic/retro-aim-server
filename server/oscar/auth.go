...
func (rt AuthServer) Start() {
	addr := net.JoinHostPort(rt.Config.OSCARListenHost, rt.Config.AuthPort)
	...
	rt.Logger.Info("starting auth service", "host", net.JoinHostPort(rt.Config.OSCARClientHost, rt.Config.AuthPort))
